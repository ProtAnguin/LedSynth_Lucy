...
uint32_t CHmask[D_NLS] = {   // Channel mask
  ...
  0b000000000000000000, // ZeroOrder              
  0b000000000000000001, // LED  1
  0b000000000000000010, // LED  2
  0b000000000000000100, // LED  3
  0b000000000000001000, // LED  4
  0b000000000000010000, // LED  5
  0b000000000000100000, // LED  6
  0b000000000001000000, // LED  7
  0b000000000010000000, // LED  8
  0b000000000100000000, // LED  9
  0b000000001000000000, // LED 10
  0b000000010000000000, // LED 11
  0b000000100000000000, // LED 12
  0b000001000000000000, // LED 13
  0b000010000000000000, // LED 14
  0b000100000000000000, // LED 15
  0b001000000000000000  // LED 16
};
...
uint16_t lambdas[D_NLS]   = { 999,   801,   802,   803,   804,   805,   806,   807,   808,   809,   810,   811,   812,   813,   814,   815,   816}; // nm
